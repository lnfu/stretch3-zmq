...
class TestJointName:
    ...
    def test_member_values(self) -> None:
        assert JointName.BASE_TRANSLATE == "base_translate"
        assert JointName.BASE_ROTATE == "base_rotate"
        assert JointName.LIFT == "lift"
        assert JointName.ARM == "arm"
        assert JointName.HEAD_PAN == "head_pan"
        assert JointName.HEAD_TILT == "head_tilt"
        assert JointName.WRIST_YAW == "wrist_yaw"
        assert JointName.WRIST_PITCH == "wrist_pitch"
        assert JointName.WRIST_ROLL == "wrist_roll"
        assert JointName.GRIPPER == "gripper"
